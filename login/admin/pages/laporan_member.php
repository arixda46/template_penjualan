            ...
            <div class="panel panel-default">
                <form action="" method="POST">
                    <div class="panel-heading">
                        ...
                        <a class="btn btn-success" target="_blank" href="cetak_laporan_member.php?status=<?php
                                                                                                            echo $_POST['status']; ?>"><i class="fa fa-print" <i class="fa fa-print">Cetak Laporan</i></a>
                    </div>
                </form>
