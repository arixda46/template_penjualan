        ...
        <div class="col-lg-12">
            <form action="" method="POST">
                <div class="panel panel-default">
                    ...
                    <a class="btn btn-success" target="_blank" href="cetak_laporan_penjualan.php?dari=<?php echo $_POST['dari']; ?>&sampai=<?php echo $_POST['sampai']; ?>">
                        <i class="fa fa-print">Cetak Laporan</i></a>
                </div>
